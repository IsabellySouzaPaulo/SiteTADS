...
public class ClienteDAO {
    ...
    public void adicionarCliente(Cliente obj) {
        ...
        try {
            //1 passo - criar o sql
            String sql = "insert into Clientes(nome, documento, tipo_cliente, telefone, email, logradouro,"
                    + " numero, complemento, bairro, cidade, estado, cep, observacoes) values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
