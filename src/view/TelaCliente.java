...
public class TelaCliente extends javax.swing.JFrame {
    ...
    private void jBtnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAdicionarActionPerformed
        if ((jTxtNome.getText().isEmpty()) || (jTxtDocumento.getText().isEmpty())){
            ...
            if(jRdBtnFisica.isSelected()){
                tipoCliente = jRdBtnFisica.getText();
                  }else{
                  tipoCliente = jRdBtnJuridica.getText();
                  }
            ...
            Cliente cliente = new Cliente(nome, documento, tipoCliente, telefone, email, logradouro, numero, complemento, bairro, cidade, estado, cep, observacoes);
    ...
    private void jTblClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTblClientesMouseClicked
        ...
        jTxtDocumento.setText(jTblClientes.getValueAt(jTblClientes.getSelectedRow(), 0).toString());
